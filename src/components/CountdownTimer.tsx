        ...
        {isComplete ? (
          ...
          timeLeft.days > 0 || (timeLeft.days === 0 && label.includes("Wedding")) ? (
            <div className="flex justify-center gap-2 sm:gap-5">
              <div className="bg-background/80 backdrop-blur-sm p-2 sm:p-5 rounded-lg text-center min-w-14 sm:min-w-20 shadow-md border border-accent/30">
            ...
            <div className="flex justify-center gap-2 sm:gap-5">
              <div className="bg-background/80 backdrop-blur-sm p-2 sm:p-5 rounded-lg text-center min-w-12 sm:min-w-16 shadow-md border border-accent/30">
